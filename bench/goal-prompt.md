...
Host: library (12 threads i5-11400H, 15G RAM, 107G free disk, Docker 29.5.3, Java 17). Rules:

- One system under test at a time. Heap cap 6G. Stop its containers before starting the next.
- Never touch wearwise_* containers or volumes. About 5G RAM is already theirs.
- Work under ~/hg-bench on library. Remove benchmark images and volumes at the end.
